...
public:
	...
	MotionProfileExample() : _talon(RobotMap::swerveSubsystemBLDriveTalon.get()), _notifer(&MotionProfileExample::PeriodicTask, this)
	{
		std::cout << "made it to motion profile" << std::endl;
		/*
